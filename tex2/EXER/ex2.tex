...
\begin{figure}
	\centering
	\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/deviation_analytical.pdf}
...
\begin{figure}
	\centering
	\includegraphics[scale = 0.5]{../MolecularDynamics/Ex2/fig/max_deviation_vs_deltat}
...
\begin{figure}
	\centering
	\includegraphics[scale = 0.5]{../MolecularDynamics/Ex2/fig/max_deviation_vs_omega.pdf}
...
$$
where the $p_i(t=0)$ were sampled from the Maxwell-Boltzmann at temperature $T=1$ thanks to the thermostat phase in LAMMPS and the configuration was chosen at random while keeping sufficient distance between the molecules. The time evolution of the total energy is reported in Fig.\ref{fig:energyLJ} for $\rho = 0.62$ and $\rho = 0.4$. Along with the relative energy variation, Fig.\ref{fig:energyHO} also displays the behavior of the temperature $T$ as a function of time. 
...
\begin{table}
	...
	\end{tabular}
		...
		\hline
	\end{tabular}
	\caption{\textit{Average temperature and associated standard deviation at different values of $r_{cut}$ when $\rho = 0.62$ (right) and $\rho = 0.4$ (left). }}
	\label{table:table2}
\end{table}

\begin{figure}
	\centering
	\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/energyLJ_0_62.pdf}
	\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/energyLJ_0_40.pdf}
...
\begin{figure}
\centering
\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/hist_kin_pot_LJ_0_62}
\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/hist_kin_pot_LJ_0_4}
\caption{\textit{Histograms for the kinetic energy per particle (on the right) and the potential energy per particle (on the left) at various cut-off distances when $\rho = 0.62$ (top band)} and $\rho = 0.4$ (bottom band)}
\label{fig:histoKU}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/rdf_LJ_0_62.pdf}
	\includegraphics[scale = 0.4]{../MolecularDynamics/Ex2/fig/rdf_LJ_0_40.pdf}
